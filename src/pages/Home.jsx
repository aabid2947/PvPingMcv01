...
const NewsCard = ({ post }) => {
  ...
  const getTagColor = (tag) => {
    switch (tag.toLowerCase()) {
      ...
      case 'minigame': return 'bg-sky-600';
      ...
      case 'dungeons': return 'bg-violet-700';
  ...
  return (
    <div className="min-h-screen bg-[#13141d] text-white mt-6  w-full">
      ...
      <div className="absolute h-1/2 my-auto right-0 top-0 bottom-0 w-1 bg-cyan-400"></div>
        ...
        <div className="hidden md:block p-1   h-[17rem] w-[40%]">
          <img
            src={frame}
